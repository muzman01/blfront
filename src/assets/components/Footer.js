      ...
      <div className="container-fluid px-5">
        <div className="row justify-content-center">
          ...
          <div className="col-lg-3 mx-lg-5 mt-5 mb-5 mt-lg-0 mb-lg-0 text-center text-lg-start">
            <h3>Follow us</h3>
            <h4>
              Contact us for up-to-date news on the Reits Dao community. Follow
          ...
          <div className="col-lg-4 ">
            <div className="row footer-bilgiler justify-content-center ">
              ...
              <div className="col-xxl-7 d-flex align-items-center mt-4 justify-content-center justify-content-lg-start">
                ...
                <h6>
                  Adalet Mah. Manas Bulv. No:47/B K:26 D:2601 Folkart Towers A
                  Kule 35530 Bayraklı İzmir, Türkiye
                </h6>
              </div>
            </div>
          </div>
