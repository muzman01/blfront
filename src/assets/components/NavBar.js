...
export default function NavBar() {
  ...
  const [nav, setNav] = useState(
    "collapse justify-content-center navbar-collapse"
  );
  const navbtn = () => {
    console.log(sayi);
    if (sayi === 0) {
        ...
        <div className="container-fluid p-0">
          ...
          <div className={nav} id="navbarSupportedContent">
            <ul className="navbar-nav mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <a className="nav-link " href="trendroyal">
                  Notice
                </a>
              </li>
          ...
          <a
            href="#contact"
            className="btn btn-outline-contact d-none d-lg-block"
          >
            Contact
          </a>
          {nav === " justify-content-center navbar-collapse" ? (
            <a
              style={{ cursor: "pointer", margin: "auto", fontSize: "30px" }}
              onClick={kapat}
            >
              {" "}
              X{" "}
