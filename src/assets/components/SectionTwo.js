        ...
        <div className="row">
            <div className="col-lg-6" >
                <div className="section-two-left pe-lg-5">
                    ...
                    <img className="img-fluid ggg" src={S2} alt=""  data-aos="zoom-in-up"  data-aos-delay="400"/>
                </div>
            </div>

            <div className="col-lg-6 mt-4 mt-lg-0"  >
                <div className="section-two-right ps-lg-5">
                    <img className="img-fluid ggg" src={S1}alt=""  data-aos="zoom-in-up"  data-aos-delay="400"/>
