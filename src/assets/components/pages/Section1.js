...
export default function Section1() {
  return (
    ...
    <div className="container-fluid">
        <h5 className="text-center text-lg-start">First real estate to be introduced on-chain via ReitsDAO</h5>
        <div
            className="d-flex align-items-center justify-content-between flex-column flex-lg-row yuzdelik text-center text-lg-start">
