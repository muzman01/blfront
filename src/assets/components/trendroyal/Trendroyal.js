          ...
          <div className="qa" id="faq">
            <div className="qaLine1">
              <div className={!isqa1 ? `questions` : `questionsAfter`}>
                <div className="question">
                  <p>Can “RDF” be converted into cash immediately?</p>
                  {!isqa1 ? (
                    <p
                ...
                {isqa1 ? (
                  <p>
                    All assets invested by investors are not owned by the Reits
                    DAO company and are safely stored on the blockchain network.
                    All real estate will be sold and paid out to “RDF” token
                    holders in the event of service issues.
                  </p>
                ) : null}
              </div>
            </div>
            ...
            <div className="qaLine2">
              <div className={!isqa3 ? `questions3` : `questions3After`}>
                <div className="question3">
                  <p>
                    Is it possible to sell “RDF” tokens immediately after the
                ...
                {isqa3 ? (
                  <>
                    <p>
                      All assets invested by investors are not owned by the
                      Reits DAO company and are safely stored on the blockchain
                      network. All real estate will be sold and paid out to
                      “RDF” token holders in the event of service issues.
                    </p>
                  </>
                ) : null}
              </div>
            ...
            <div className="qaLine2">
              <div className={!isqa6 ? `questions5` : `questions5After`}>
                <div className="question5">
                  <p>Are the assets invested in Ritz Dao Finance safely operated?</p>
                  {!isqa6 ? (
                    <p
                      style={{ cursor: "pointer" }}
            ...
            <div className="qaLine2">
              <div className={!isqa2 ? `questions5` : `questions5After`}>
                <div className="question5">
                  <p>How is the initial listing price of “RDF” token formed?</p>
                  {!isqa2 ? (
                    <p
                      style={{ cursor: "pointer" }}
